...
public class PerchanceConnectActivity extends Activity {
    ...
    private void buildUi() {
        ...
        info.setText("v0.4.2는 최신 Android Chrome과 같은 브라우저 형식으로 Perchance를 열어. userKey나 내부 /api/generate 대신 Harin 전용 bridge가 공식 AI Text Plugin과 Text-to-Image Plugin을 import해. 아래 원본 화면에서 브라우저 검증이 나오면 직접 완료해 줘.");
        info.setTextSize(13);
